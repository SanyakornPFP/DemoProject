...
namespace phoneBill.Data
{
    ...
    public partial class db_phonebillModel : DbContext
    {
        ...
        public virtual DbSet<Month> Months
        {
            get;
            set;
        }
        ...
        public virtual DbSet<VMonth> VMonths
        {
            get;
            set;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            this.MonthMapping(modelBuilder);
            this.CustomizeMonthMapping(modelBuilder);
            ...
            this.VMonthMapping(modelBuilder);
            this.CustomizeVMonthMapping(modelBuilder);
        ...
        #region Month Mapping

        private void MonthMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Month>().ToTable(@"Month", @"dbo");
            modelBuilder.Entity<Month>().Property(x => x.ID).HasColumnName(@"ID").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Month>().Property(x => x.Month1).HasColumnName(@"Month").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Month>().Property(x => x.Number).HasColumnName(@"Number").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Month>().HasKey(@"ID");
        }

        partial void CustomizeMonthMapping(ModelBuilder modelBuilder);
        ...
        #region VMonth Mapping

        private void VMonthMapping(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<VMonth>().ToTable(@"V_Month", @"dbo");
            modelBuilder.Entity<VMonth>().Property(x => x.ID).HasColumnName(@"ID").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<VMonth>().Property(x => x.Month).HasColumnName(@"Month").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<VMonth>().HasKey(@"ID");
        }

        partial void CustomizeVMonthMapping(ModelBuilder modelBuilder);
        ...
        private void VBilllistMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VBilllist>().Property(x => x.MonthBill).HasColumnName(@"MonthBill").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            ...
            modelBuilder.Entity<VBilllist>().Property(x => x.Month).HasColumnName(@"Month").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
